...
// Ported from React Bits' Strands (JS + CSS variant), logic unchanged — the
// flowing glow-strand background for the landing page (this doc's own
// placement note).
